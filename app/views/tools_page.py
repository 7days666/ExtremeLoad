...
TOOLS_SOURCES = {
    "Postman": {
        "name": "Postman", "desc": "API 调试工具",
        "url": "https://dl.pstmn.io/download/latest/win64",
        "filename": "Postman-Setup.exe", "website": "https://www.postman.com/downloads/", "icon": FIF.SEND
    },
    "Apifox": {
        "name": "Apifox", "desc": "API 一体化协作平台",
        "url": "https://cdn.apifox.cn/download/Apifox-windows-latest.exe",
        "filename": "Apifox-Setup.exe", "website": "https://apifox.com/", "icon": FIF.DOCUMENT
    },
    "DBeaver": {
        "name": "DBeaver", "desc": "通用数据库管理工具",
        "url": "https://dbeaver.io/files/dbeaver-ce-latest-x86_64-setup.exe",
        "filename": "dbeaver-ce-setup.exe", "website": "https://dbeaver.io/download/", "icon": FIF.DICTIONARY
    },
    "Docker": {
        "name": "Docker Desktop", "desc": "容器化平台",
        "url": "https://desktop.docker.com/win/main/amd64/Docker%20Desktop%20Installer.exe",
        "filename": "Docker-Desktop-Installer.exe", "website": "https://www.docker.com/products/docker-desktop/", "icon": FIF.CLOUD
    },
    "Notepad++": {
        "name": "Notepad++", "desc": "轻量级代码编辑器",
        "url": "https://github.com/notepad-plus-plus/notepad-plus-plus/releases/download/v8.6.9/npp.8.6.9.Installer.x64.exe",
        "filename": "npp-Installer.exe", "website": "https://notepad-plus-plus.org/downloads/", "icon": FIF.EDIT
    },
    "7-Zip": {
        "name": "7-Zip", "desc": "开源压缩工具",
        "url": "https://www.7-zip.org/a/7z2408-x64.exe",
        "filename": "7z-x64.exe", "website": "https://www.7-zip.org/", "icon": FIF.ZIP_FOLDER
    },
    "Everything": {
        "name": "Everything", "desc": "极速文件搜索",
        "url": "https://www.voidtools.com/Everything-1.4.1.1026.x64-Setup.exe",
        "filename": "Everything-Setup.exe", "website": "https://www.voidtools.com/", "icon": FIF.SEARCH
    },
    "Snipaste": {
        "name": "Snipaste", "desc": "截图贴图工具",
        "url": "https://dl.snipaste.com/win-x64",
        "filename": "Snipaste-Setup.exe", "website": "https://www.snipaste.com/", "icon": FIF.PHOTO
    },
}
...
class ToolsPage(QWidget):
    def __init__(self, parent=None):
        ...
        self.save_dir = os.path.join(os.path.expanduser("~"), "Downloads", "DevTools")
        self._init_ui()
    ...
    def _init_ui(self):
        ...
        title_layout = QHBoxLayout()
        title_layout.addWidget(IconWidget(FIF.APPLICATION))
        title_layout.addSpacing(8)
        title_layout.addWidget(TitleLabel("常用工具下载"))
        ...
        content_layout.addWidget(BodyLabel("开发常用辅助工具一键下载"))
        ...
        self.cards = []
        for key, info in TOOLS_SOURCES.items():
            card = ToolCard(key, info, self._get_save_dir, self._get_auto_open, self)
